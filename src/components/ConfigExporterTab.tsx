    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="inline-flex items-center space-x-1.5 px-3.5 py-2 rounded-lg text-xs font-semibold bg-emerald-500 hover:bg-emerald-400 text-black shadow-md shadow-emerald-500/20 font-bold transition-all"
          >
      ...
      <div className="rounded-xl bg-slate-950 border border-slate-800 overflow-hidden shadow-2xl">
        ...
        <div className="p-4 sm:p-6 overflow-x-auto max-h-[550px] scrollbar-thin">
          <pre className="text-xs font-mono text-slate-200 leading-relaxed whitespace-pre selection:bg-emerald-500/30">
            {currentFile.content}
          </pre>
        </div>
      </div>
